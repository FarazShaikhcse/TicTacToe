...
public class TicTacToeGame {
 ...
 public char canOpponentWin() {
  ...
  if ((board[1] == ' ')
    && ((board[2] == board[3]) && (board[2] == playerLetter) || (board[4] == board[7]) && (board[4] == playerLetter)
      || (board[5] == board[9]) && (board[5] == playerLetter))) {

   board[1] = computerLetter;
   return 'y';
  } else if ((board[2] == ' ') && ((board[1] == board[3]) && (board[1] == playerLetter)
    || (board[5] == board[8]) && (board[5] == playerLetter))) {
   board[2] = computerLetter;
   return 'y';
  } else if ((board[3] == ' ')
    && ((board[2] == board[1]) && (board[2] == playerLetter) || (board[6] == board[9]) && (board[6] == playerLetter)
      || (board[5] == board[7]) && (board[5] == playerLetter))) {
   board[3] = computerLetter;
   return 'y';
  } else if ((board[4] == ' ') && ((board[1] == board[7]) && (board[1] == playerLetter)
    || (board[5] == board[6]) && (board[6] == playerLetter))) {
   board[4] = computerLetter;
   return 'y';
  } else if ((board[5] == ' ') && ((board[1] == board[9]) && (board[1] == playerLetter)
    || (board[3] == board[7]) && (board[3] == playerLetter) || (board[2] == board[8]) && (board[2] == playerLetter)
    || (board[4] == board[6]) && (board[4] == playerLetter))) {
   board[5] = computerLetter;
   return 'y';
  } else if ((board[6] == ' ') && ((board[3] == board[9]) && (board[3] == playerLetter)
    || (board[4] == board[5]) && (board[4] == playerLetter))) {
   board[6] = computerLetter;
   return 'y';
  } else if ((board[7] == ' ')
    && ((board[1] == board[4]) && (board[1] == playerLetter) || (board[8] == board[9]) && (board[8] == playerLetter)
      || (board[5] == board[3]) && (board[5] == playerLetter))) {
   board[7] = computerLetter;
   return 'y';
  } else if ((board[8] == ' ') && ((board[2] == board[5]) && (board[2] == playerLetter)
    || (board[7] == board[9]) && (board[7] == playerLetter))) {
   board[8] = computerLetter;
   return 'y';
  } else if ((board[9] == ' ')
    && ((board[1] == board[5]) && (board[1] == playerLetter) || (board[3] == board[6]) && (board[3] == playerLetter)
      || (board[7] == board[8]) && (board[7] == playerLetter))) {
